...
from lanetcls import LANetCls
import random, os
from time import time, sleep
from config import lanet_args, batch_size, learning_rate as lr, label_smoothing as ls, epoch, warmup
...
traindlr = DataLoader(ScanObjectNN(), batch_size=batch_size, 
...
model = LANetCls(lanet_args).cuda()
...
metric = util.Metric(lanet_args.num_classes)
