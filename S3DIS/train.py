...
from lanetsemseg import LANetSemSeg
from time import time, sleep
from config import s3dis_args, s3dis_warmup_args, lanet_args, batch_size, learning_rate as lr, epoch, warmup, label_smoothing as ls
...
model = LANetSemSeg(lanet_args).cuda()
